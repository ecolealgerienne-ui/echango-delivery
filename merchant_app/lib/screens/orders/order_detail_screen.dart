...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) context.read<OrderState>().selectOrder(widget.orderId);
    });
  }

  Future<void> _cancel(OrderState orderState) async {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, _) {
        if (didPop) context.read<OrderState>().clearSelection();
      },
      child: Scaffold(
