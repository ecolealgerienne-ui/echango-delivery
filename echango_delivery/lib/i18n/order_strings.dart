...
const Map<String, String> _fr = {
  ...
  'order.nav.more': 'Plus',
  'order.more.tournee': 'Nouvelle tournée',
  'order.more.tournee.hint': 'Une livraison à plusieurs arrêts',
...
const Map<String, String> _ar = {
  ...
  'order.more.tournee': 'جولة جديدة',
  'order.more.tournee.hint': 'توصيلة بعدّة محطات',
