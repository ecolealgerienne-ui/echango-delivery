...
const Map<String, String> _fr = {
  ...
  'order.track.created': 'Créée',
  'order.track.enroute': 'En route',
  'order.track.delivered': 'Livrée',
  'order.track.canceled': 'Annulée',
  ...
  'driver.order.tournee.title': 'Arrêts de la tournée',
  'driver.order.tournee.count': '{n} arrêts',
  'driver.order.tournee.pickup': 'Enlèvement',
  'driver.order.tournee.dropoff': 'Livraison',
  ...
  'order.nav.orders': 'Livraisons',
  'order.nav.addresses': 'Adresses',
  'order.nav.favourites': 'Transporteurs',
  'order.nav.more': 'Plus',
  // ── Un seul point d'entrée : le bouton « + » ouvre le choix livraison /
  // tournée. Avant, la tournée était enterrée dans le panneau « Plus » — deux
  // façons de créer une course, à deux endroits.
  'order.new.fab': 'Nouvelle course',
  'order.new.sheet': 'Que voulez-vous créer ?',
  'order.new.delivery': 'Une livraison',
  'order.new.delivery.hint': 'Un enlèvement, une adresse de livraison',
  'order.new.tournee': 'Une tournée',
  'order.new.tournee.hint': 'Plusieurs arrêts sur une même route',
  'order.list.reorder': 'Refaire',
...
const Map<String, String> _ar = {
  ...
  'order.track.created': 'أُنشئت',
  'order.track.enroute': 'في الطريق',
  'order.track.delivered': 'سُلّمت',
  'order.track.canceled': 'أُلغيت',
  ...
  'driver.order.tournee.title': 'محطات الجولة',
  'driver.order.tournee.count': '{n} محطات',
  'driver.order.tournee.pickup': 'استلام',
  'driver.order.tournee.dropoff': 'تسليم',
  ...
  'order.nav.orders': 'التوصيلات',
  'order.nav.addresses': 'العناوين',
  'order.nav.favourites': 'الناقلون',
  'order.nav.more': 'المزيد',
  'order.new.fab': 'توصيل جديد',
  'order.new.sheet': 'ماذا تريد أن تنشئ؟',
  'order.new.delivery': 'توصيلة',
  'order.new.delivery.hint': 'استلام واحد، عنوان تسليم واحد',
  'order.new.tournee': 'جولة',
  'order.new.tournee.hint': 'عدّة محطات على نفس المسار',
  'order.list.reorder': 'إعادة',
